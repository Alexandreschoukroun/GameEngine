...
| **M6.5** | Niveau : générateur de plan, relief d'architecture, mobilier et portes à partir de modèles libres | ✅ Terminé |
...
- [`docs/10-niveau.md`](docs/10-niveau.md) : le niveau — générateur de plan, relief d'architecture, enroulement des faces, collision d'un modèle importé
